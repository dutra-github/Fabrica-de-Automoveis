...
public class FabricaDeAutomoveis {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < carros.length; i++) {
			...
			int potencia = Integer.parseInt(JOptionPane.showInputDialog("Informe a pot�ncia do motor"));
			...
			String tipoCombustivel = JOptionPane.showInputDialog("Informe o tipo de combust�vel do motor");
			...
			m1.setTorque(torque);
			int qtdValvulas = Integer.parseInt(JOptionPane.showInputDialog("Informe a qtd de v�lvulas do motor"));
